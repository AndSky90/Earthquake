...
public class EarthquakeMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState==null) { //добавляем EqListFr в mainframe, проверяем запущена ли она в 1й раз или реконфиг
        ...
        Date now = Calendar.getInstance().getTime();//заглушка
        List<Earthquake> dummyQuakes = new ArrayList<>(0);
        dummyQuakes.add(new Earthquake("0",now,"Tuapse",null,7.3,null));
        dummyQuakes.add(new Earthquake("1", now, "KRD", null, 6.5,null));
